...
/**
 * Clase que representa una expresión de comparación menor o igual.
 * Valor1 <= Valor2
 */
public class MenorIgual extends Instruccion {

    private Instruccion operIzq;
    private Instruccion operDer;

    /**
     * Constructor de la clase MenorIgual.
     ...
     */
    public MenorIgual(Instruccion operDer, Instruccion operIzq, int linea, int columna) {
