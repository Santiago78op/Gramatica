...
/**
 * Clase que representa una expresión de comparación de menor.
...
public class Menor extends Instruccion {
    ...
    private void addSemanticError(tipoDato tipoIzq, tipoDato tipoDer, int linea, int columna) {
        ...
        errorSemantico.addError(new Errores("Semantico", "Error de tipos en la operación Menor. " +
                "\n No se puede realizar Menor entre\n" + tipoIzq + " y " + tipoDer, linea, columna));
    }
}
