...
/**
 * Clase que representa una expresión de multiplicación.
 * Valor = Valor1 * Valor2
 */
public class Multiplica extends Instruccion{
    ...
    /**
     * Constructor de la clase Multiplica.
     ...
     */
    public Multiplica(Instruccion operIzq, Instruccion operDer, int linea, int columna) {
    ...
    public Object interpretar(Arbol arbol, tablaSimbolo tablaDeSimbolos) {
        ...
        // Implementacion de tabla de operatorias para la multiplicación.
        switch (tipoIzq){
            case ENTERO -> {
                switch (tipoDer){
                    case ENTERO -> {
    ...
    private Errores addSemanticError(tipoDato tipoIzq, tipoDato tipoDer, int linea, int columna) {
        Errores error = new Errores("Semantico", "Error de tipos en la operación Multiplicacion. " +
